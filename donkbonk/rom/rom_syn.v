...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="MAX 10" ENABLE_RUNTIME_MOD="NO" INIT_FILE="./rom/tetris piece rom init.hex" NUMWORDS_A=64 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=6 address_a clock0 q_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "./rom/tetris piece rom init.hex",
	...
	defparam
		...
		ram_block1a_1.init_file = "./rom/tetris piece rom init.hex",
	...
	defparam
		...
		ram_block1a_2.init_file = "./rom/tetris piece rom init.hex",
	...
	defparam
		...
		ram_block1a_3.init_file = "./rom/tetris piece rom init.hex",
	...
	defparam
		...
		ram_block1a_4.init_file = "./rom/tetris piece rom init.hex",
	...
	defparam
		...
		ram_block1a_5.init_file = "./rom/tetris piece rom init.hex",
	...
	defparam
		...
		ram_block1a_6.init_file = "./rom/tetris piece rom init.hex",
	...
	defparam
		...
		ram_block1a_7.init_file = "./rom/tetris piece rom init.hex",
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: MGL_INTERNAL_WARNING: (Invalid line found in memory file.  Invalid line --  -- found in file ./rom/tetris piece rom init.hex)  ");
		$display("Warning: Memory initialization file ./rom/tetris piece rom init.hex is not found. This may result in inconsistent simulation results.");
	end
